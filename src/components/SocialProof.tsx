...
function CertificateIcon({ className }: { className?: string }) {
    return (
        ...
        >
            ...
            />
            <path
                d="M10 8a4 4 0 0 1 4-4h32a4 4 0 0 1 4 4v12H10V8z"
                fill="currentColor"
                fillOpacity="0.2"
            />
            <line
                ...
                <div ref={ref} className={s.grid}>
                    ...
                    >
                        ...
                        <div className={s.imageBadge}>
                            ...
                            <span className={s.badgeLabel}>Data accuracy</span>
                        </div>
                    </motion.div>
                </div>
