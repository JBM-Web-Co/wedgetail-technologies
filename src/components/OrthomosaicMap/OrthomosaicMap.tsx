    ...
    ys.flatMap((y, ri) =>
        xs.map(
            (x, ci): HouseConfig => [
                x,
                y,
                ROOFS[(ri * xs.length + ci + offset) % ROOFS.length] ??
                    '#c08050',
            ]
        )
    );
    ...
    <div className={s.wrapper}>
        <div className={s.rotating}>
            ...
            >
                ...
                {[
                    4, 22, 42, 62, 72, 100, 120, 140, 162, 180, 226, 250, 272,
                    294, 314, 334, 360, 382, 402, 424, 444,
                ].map((x) => (
                    <rect
                        key={`sh1${x}`}
                        x={x}
                ...
                {[
                    4, 22, 42, 62, 74, 100, 120, 140, 160, 180, 226, 250, 272,
                    292, 314, 334, 360, 382, 404, 424, 444,
                ].map((y) => (
                    <rect
                        key={`sv1${y}`}
                        x="92"
                ...
                {[
                    226, 246, 266, 288, 308, 328, 348, 366, 386, 406, 426, 446,
                ].map((x) => (
                    <rect
                        key={`mhr${x}`}
                        x={x}
